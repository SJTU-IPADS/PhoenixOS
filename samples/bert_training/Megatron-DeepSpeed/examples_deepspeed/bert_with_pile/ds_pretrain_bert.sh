...
data_path="${data_home}/BookCorpusDataset_text_document"

vocab_path="/data/bert-large-uncased-vocab.txt"
...
deepspeed ${dir}/../../pretrain_bert.py ${megatron_options} ${data_options} ${deepspeed_options} &>> ./log.txt